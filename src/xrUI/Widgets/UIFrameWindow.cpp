...
bool CUIFrameWindow::InitTextureEx(pcstr texture, pcstr shader, bool fatal /*= true*/)
{
    ...
    const bool back_exist = CUITextureMaster::InitTexture(xr_strconcat(buf, texture, "_back"), shader, m_shader, m_tex_rect[fmBK]);
    const bool left_exist = CUITextureMaster::InitTexture(xr_strconcat(buf, texture, "_l"), shader, m_shader, m_tex_rect[fmL]);
    const bool right_exist = CUITextureMaster::InitTexture(xr_strconcat(buf, texture, "_r"), shader, m_shader, m_tex_rect[fmR]);
    const bool top_exist = CUITextureMaster::InitTexture(xr_strconcat(buf, texture, "_t"), shader, m_shader, m_tex_rect[fmT]);
    const bool bottom_exist = CUITextureMaster::InitTexture(xr_strconcat(buf, texture, "_b"), shader, m_shader, m_tex_rect[fmB]);

    const bool leftTop_exist = CUITextureMaster::InitTexture(xr_strconcat(buf, texture, "_lt"), shader, m_shader, m_tex_rect[fmLT]);
    const bool rightBottom_exist = CUITextureMaster::InitTexture(xr_strconcat(buf, texture, "_rb"), shader, m_shader, m_tex_rect[fmRB]);
    const bool rightTop_exist = CUITextureMaster::InitTexture(xr_strconcat(buf, texture, "_rt"), shader, m_shader, m_tex_rect[fmRT]);
    const bool leftBottom_exist = CUITextureMaster::InitTexture(xr_strconcat(buf, texture, "_lb"), shader, m_shader, m_tex_rect[fmLB]);
